...
@interface DInnerMaster ()

@end

@implementation DInnerMaster

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.bl = [[NoteBLDinner alloc] init];
    self.listData = [self.bl findAllForDinner];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NoteDinner   *note = self.listData[indexPath.row];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        NoteBLDinner *note = [self.listData objectAtIndex:[indexPath row]];
        NoteBLDinner *bl = [[NoteBLDinner alloc] init];
        self.listData = [bl removeDinner: note];
