...
#import "BreakfastTableView.h"

@interface BreakfastTableView ()

@end

@implementation BreakfastTableView
...
//    NSInteger selectedIndex = [[self.tableView indexPathForSelectedRow] row];
    ...
    NSMutableArray *reslist = [bl createNoteForBreakfast: note];
